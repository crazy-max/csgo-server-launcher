...
```
$ sudo curl -sSLk https://github.com/crazy-max/csgo-server-launcher/releases/download/v1.13.5/install.sh | sudo bash
```
...
$ curl -sSLk https://github.com/crazy-max/csgo-server-launcher/releases/download/v1.13.5/csgo-server-launcher.sh -o /etc/init.d/csgo-server-launcher
